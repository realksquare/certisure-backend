...
exports.Line = exports.LineDirection = void 0;
...
class Line extends Shape_1.Shape {
    ...
    init() {
        let from = this.from;
        let to = this.to;
        if (Math.abs(from.y - to.y) < Shape_1.Shape.tolerance) {
        ...
        else if (Math.abs(from.x - to.x) < Shape_1.Shape.tolerance) {
    ...
    get valid() {
        if (this._valid === undefined) {
            this._valid = this.direction !== LineDirection.None && this.length > Shape_1.Shape.tolerance;
        }
        return this._valid;
    }
    get normalized() {
        if (this.direction === LineDirection.Horizontal) {
            return new Line(new Point_1.Point(this.from.x - Shape_1.Shape.tolerance, this.from.y), new Point_1.Point(this.to.x + Shape_1.Shape.tolerance, this.from.y));
        }
        else if (this.direction === LineDirection.Vertical) {
            return new Line(new Point_1.Point(this.from.x, this.from.y - Shape_1.Shape.tolerance), new Point_1.Point(this.from.x, this.to.y + Shape_1.Shape.tolerance));
        }
        return this;
    }
    addGap(line) {
    ...
    intersection(line) {
        ...
        if (this.direction === LineDirection.Horizontal && line.direction === LineDirection.Vertical) {
            ...
            if (isOk) {
                const intPoint = new Point_1.Point(x, y);
    ...
    transform(matrix) {
        ...
        this.from = new Point_1.Point(x, y);
        this.to = new Point_1.Point(x + width, y + height);
        this.init();
        return this;
    }
}
